...
HD_PWD='/media/edabk2003/data/kien/TKS/ibex_zcu104/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_zcu104.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_zcu104.tcl
